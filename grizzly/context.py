...
if TYPE_CHECKING:  # pragma: no cover
    from .tasks import GrizzlyTask, ParallellRequestTask
...
class GrizzlyContextScenario:
    ...
    parallell_group: Optional['ParallellRequestTask'] = field(init=False, repr=False, hash=False, compare=False, default=None)
