Feature: grizzly example
  ...
  Scenario: book api
    ...
    Then get request with name "get-book" from endpoint "/books/{{ AtomicCsvRow.books.book }}.json"
    ...
    Then get request with name "get-author" from endpoint "{{ author_endpoint }}.json"
