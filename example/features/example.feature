Feature: grizzly example
  ...
  Scenario: book api
    ...
    Then get request with name "1-get-book" from endpoint "/books/{{ AtomicCsvRow.books.book }}.json"
    ...
    Then get request with name "2-get-author" from endpoint "{{ author_endpoint }}.json"
