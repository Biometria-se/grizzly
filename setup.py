...
setup(
    ...
    install_requires=[
        ...
        'jsonpath-ng>=1.5.3',
        #'locust==2.8.3',
        'locust @ git+https://github.com/mgor/locust.git@fb4591cbe2074f9b8d37c7b588a8e20a25c714f8#egg=locust',
        'lxml>=4.8.0',
    ...
    extras_require={
        ...
        'dev': [
            ...
            'mypy>=0.931',
            'pip-licenses>=3.5.3',
            #'pydoc-markdown>=4.5.1,<5.0.0',
            'pydoc-markdown @ https://github.com/mgor/pydoc-markdown/archive/refs/heads/feature/dependencies_hell.zip#egg=pydoc_markdown',
            'pylint>=2.12.2',
